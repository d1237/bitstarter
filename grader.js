...
var HTMLURL_DEFAULT = "https://github.com/d1237/bitstarter/blob/master/index.html";
...
var aux_url = function(st_html,checksfile) {
    //console.log("st_html.substr(0,100):");
    //console.log(st_html.substr(0,100));
    $ = cheerio.load(st_html);
...
var cheerioHtmlURL = function(htmlURL, checksfile) {
    //console.log("htmlURL:");
    //console.log(htmlURL);
    var u = rest.get(htmlURL,'string').on('complete',function(result){aux_url(result,checksfile);});
//    console.log("u:");
//    console.log(u);
    var b = new Buffer(u);
    return cheerio.load(u);
}
...
//	console.log(program.url);
	//r = rest.request(program.url.toString(),"");
	//r = new Buffer(r1);
	//console.log("r:");
	// console.log(r);
